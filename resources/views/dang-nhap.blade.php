                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="index.html">
                                        <span><img src="/images/logo-dark.png" alt="" height="26"></span>
                                    </a>
                                    <p class="text-muted mb-4 mt-3">Nhập tên tài khoản  và mật khẩu vào mẫu sau</p>
                                </div>

                                <h5 class="auth-title">Đăng nhập</h5>

                                <form action="{{ route('xy_ly_dang_nhap') }}" method="POST">
                                    @csrf
                                    <div class="form-group mb-3">
                                        <label for="ten_dang_nhap">Tên Đăng Nhập</label>
                                        <input class="form-control"
                                        type="text" id="ten_dang_nhap" name="ten_dang_nhap"  placeholder="Nhập tên tài khoản">
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="custom-control custom-checkbox checkbox-info">
                                            ...
                                            <label class="custom-control-label" for="checkbox-signin">Ghi nhớ mật khẩu</label>
                                        </div>
                                    </div>
